...
public class Admin {
    ...
    // vai obrigar o programa ter só um admin porque nao faria sentido ter dois ou mais (singleton)
    ...
    private String[][] doctorsAccounts = { { "mariana.mendes@medicals.com", "mari@458" },
            { "pietra.freitas@medicals.com", "91frei@!" }, { "wemilly.souza@medicals.com", "ue54!mi" },
            { "rebeca.queiroz@medicals.com", "b48@qu" }, { "hicaro.silva@medicals.com", "lov#47@" },
            { "pedro.carvalho@medicals.com", "p3p3u@2013" } };
    ...
    void AddDoctors() {
        loginDoctor.put("mariana.mendes@medicals.com",
                new Doctor("Mariana Mendes", "mariana.mendes@medicals.com", "Dentista"));
        loginDoctor.put("pietra.freitas@medicals.com",
                new Doctor("Pietra Freitas", "pietra.freitas@medicals.com", "Ginecologista"));
        loginDoctor.put("wemilly.souza@medicals.com",
                new Doctor("Wemilly Souza", "wemilly.souza@medicals.com", "Dermatologista"));
        loginDoctor.put("rebeca.queiroz@medicals.com",
                new Doctor("Rebeca Queiroz", "rebeca.queiroz@medicals.com", "Nutricionista"));
        loginDoctor.put("hicaro.silva@medicals.com", new Doctor("Hicaro Silva", "hicaro.silva@med", "Proctologista"));
        loginDoctor.put("pedro.carvalho@medicals.com",
                new Doctor("Pedro Carvalho", "pedro.carvalho@medicals.com", "Clínico Geral"));
    ...
    void AddDummyPatients() {
        ...
        loginPatients.put("johab.manoel@patients.com",
                new Patients("Johab Manoel", "johab.manoel@patients.com", "07/07/1887", "j0h4b"));
        loginPatients.put("selena.gomez@patients.com",
                new Patients("Selena Gomez", "selena.gomez@patients.com", "22/07/1992", "amoofaustao"));
    ...
    public HashMap<String, Doctor> getLoginDoctor() {
        return loginDoctor;
    }

    public HashMap<String, Patients> getLoginPatients() {
